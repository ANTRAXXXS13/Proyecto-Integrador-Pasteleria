            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade in show active" id="login" role="tabpanel">
                    ...
                    <div class="modal-body mb-1">
                        ...
                        <form class="login-form" action="php/scripts/login.php" method="POST">
                            <!--Login: email-->
                            <div class="form-row">
                                <div class="form-group input-group col-md">
                                    ...
                                    <input type="email" id="email" name="email" class="form-control validate" placeholder="correo electrónico">
                            ...
                            <button class="btn btn-info" type="submit" id="submit" name="submit">Ingresa</button>
                            </div>
                        </form>
                    </div>
                ...
                <div class="tab-pane fade" id="registro" role="tabpanel">
                    ...
                    <div class="modal-body">
                        <form class="signup-form" action="php/scripts/registro.php" method="POST">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group input-group-sm col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="aPat" name="aPat" placeholder="Apellido Paterno" >
                                ...
                                <div class="form-group input-group-sm col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="aMat" name="aMat" placeholder="Apellido Materno" >
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group input-group input-group-sm date col-md">
                                    ...
                                    <input type="text" class="form-control" data-toggle="datepicker" id="fechNac" name="fechNac" placeholder="Fecha de nacimiento" >
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group input-group-sm col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="numExt" name="numExt" placeholder="Num. Ext" >
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group input-group-sm col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="codPost" name="codPost" placeholder="Código Postal" >
                            ...
                            <div class="text-center form-sm mt-2">
                                <button class="btn btn-info" type="submit" id="submit" name="submit">Crear cuenta</button>
                            </div>
                        </form>
