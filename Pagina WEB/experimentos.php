							...
							<div class="modal-body mb-1">
								...
								<div class="form-row">
									<div class="form-group input-group col-md">
										...
										<input type="email" id="correo" name="correo" class="form-control validate" placeholder="correo electrónico" required>
								...
								<div class="form-row">
									<div class="form-group input-group col-md">
										...
										<input type="password" id="pass" name="pass" class="form-control validate"  placeholder="contraseña" required>
								...
								<div class="text-center mt-2">
									<button type="submit" class="btn btn-info" id="ingresar" name="ingresar">Ingresar</button>
								</div>
								</form>
							</div>
